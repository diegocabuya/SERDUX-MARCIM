...
to rate-and-parameter-setup
  ...
  set nl number-of-nodes-connexions
...
to python-setup ; Initializes Python and imports libraries
  py:setup ;"C:\Users\diego\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Python 3.12\Python 3.12 (64-bit).lnk"
  py:python
  (py:run
    "import math"
    "import sys"
...
to python-equation-solver ;Solve the system of differential equations in Python
  ...
  (py:run
    ...
    ;RATES (FALTA INCORPORAR LOS NUEVOS CALCULOS DE RATES)
  ...
  ;Find the closes intex to t_eval
